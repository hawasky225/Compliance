...
export default async function AdminPage() {
  ...
  return <main className="page-shell"><div className="page-head"><div><p className="eyebrow">ADMINISTRATION</p><h1>Pilotage Compliance</h1><p>Gérez les formations, examens, professionnels et certifications.</p></div><Link className="outline-btn" href="/dashboard">← Espace professionnel</Link></div>
